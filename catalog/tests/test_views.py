...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_author = models.Author.objects.create(first_name='John',
                                                   last_name='Smith')
        ...
        for book_copy in range(number_of_book_copies):
            ...
            status = 'm'
            models.BookInstance.objects.create(book=test_book,
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        get_ten_books = models.BookInstance.objects.all()[:10]
    ...
    def test_pages_paginated_to_ten(self):
        ...
        for copy in models.BookInstance.objects.all():
            copy.status = 'o'
            copy.save()
        login = self.client.login(username='testuser1',
                                  password='1X<ISRUkw+tuK')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_genre = models.Genre.objects.create(name='Fantasy')
        test_language = models.Language.objects.create(name='English')
        test_book = models.Book.objects.create(title='Book Title',
                                               summary='My book summary',
                                               isbn='ABCDEFG',
                                               author=test_author,
                                               language=test_language,
        ...
        self.test_bookinstance1 = models.BookInstance.objects.create(book=test_book,
                                                                     imprint='Unlikely Imprint, 2016',
                                                                     due_back=return_date,
                                                                     borrower=test_user1,
                                                                     status='o')
        ...
        return_date = datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance2 = models.BookInstance.objects.create(book=test_book,
                                                                     imprint='Unlikely Imprint, 2016',
                                                                     due_back=return_date,
                                                                     borrower=test_user2,
                                                                     status='o')
